    ...
    return (
        ...
        <div className="min-h-screen px-6 py-4" style={{
            ...
            <div className="space-y-10">
                ...
                <div className=" fixed mb-6 text-gray-700 z-50 shadow-md bg-[#2e78a9]">
                    <div className="grid grid-flow-col gap-0 mb-6 mt-5 mr-0">
                        ...
                        <div className="w-[206px] h-[180px] flex flex-col items-center justify-center text-3xl">
                            <img src={icon2} alt="icon" className="w-[48px] h-[48px] mb-2 " />
                        ...
                        {/* 5th column */}
                        <div className="w-[190px] h-[180px] flex flex-col items-center justify-center text-3xl">
                            <img src={icon3} alt="icon" className="w-[48px] h-[48px] mb-2" />
                            <span className="text-[16px] text-center text-[#CFE5F0]">
                                Social Link
                            </span>
                        </div>
                        ...
                        {/* 7th column */}
                        <div className="w-[190px] h-[180px] flex flex-col items-center justify-center text-3xl">
                            <img src={icon4} alt="icon" className="w-[48px] h-[48px] mb-2" />
                            <span className="text-[16px] text-center text-[#CFE5F0]">
                                Documents
                            </span>
                        </div>
                        ...
                        {/* 9th column */}
                        <div className="w-[190px] h-[180px] flex flex-col items-center justify-center text-3xl">
                            <img src={icon5} alt="icon" className="w-[48px] h-[48px] mb-2" />
                            <span className="text-[16px] text-center text-[#CFE5F0]">
                                Account Details
                            </span>
                        </div>
            ...
            {/* Form Section */}
            <div className="space-y-10 mt-70">
                {/* Institute Details */}
                <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" className="w-full p-2 rounded bg-white/20 text-white border border-[#4771AE] outline-none" />
                        </div>
                        <div>
                            <label className="block text-sm mb-1 text-left">Registered Date</label>
                            <input type="" className="w-full p-2 rounded bg-white/20 text-white border border-[#4771AE] outline-none" />
                        </div>
                        <div className="col-span-1 md:col-span-2">
                            <label className="block text-sm mb-1 text-left">Description</label>
                            <textarea className="w-full p-2 rounded bg-white/20 text-white border border-[#4771AE] outline-none" rows={3}></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" className="w-full p-2 rounded-lg bg-white/20 text-white border border-[#4771AE] outline-none" />
                        </div>
                        <div>
