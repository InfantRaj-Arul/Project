...
const PlanForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-auto flex items-center justify-center p-6 bg-transparent">
      {/* ✅ Just added overflow-hidden here for rounded corners */}
      <div className="relative w-full rounded-2xl overflow-hidden bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})` }}>
